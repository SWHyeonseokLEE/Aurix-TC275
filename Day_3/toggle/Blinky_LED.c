...
#define LED2         &MODULE_P00,3                                           /* LED: Port, Pin definition            */
#define LED3         &MODULE_P00,7                                           /* LED: Port, Pin definition            */
...
void blinkLED(void)
{
 ...
 if(i%5==0){IfxPort_togglePin(LED1);}
 if(i%10==0){IfxPort_togglePin(LED2);}
 if(i%20==0){IfxPort_togglePin(LED3);}
