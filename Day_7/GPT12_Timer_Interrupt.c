...
#define RELOAD_VALUE_50ms                   4883u                       /* Reload value to have an interrupt each 500ms         */
#define RELOAD_VALUE_10ms                   977u                        /* Reload value to have an interrupt each 500ms         */
...
void interruptGpt12_T2(void)
{
   ...
   waitTime(IfxStm_getTicksFromMilliseconds(BSP_DEFAULT_TIMER, 9.7));
